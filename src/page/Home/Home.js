...
import { AddStoryIcon, AvatarIcon } from '../../components/icons';
        ...
        <div style={{ width: '605px' }}>
          <div className={cx('title')}>
            <div className={cx('title-think')}>
              {<AvatarIcon classNames={cx('title-think__avatar')} src={avatar} />}
              <input className={cx('title-think__feeling')} placeholder="Bảo ơi, bạn đang nghĩ gì thế?" />
            </div>
            <div className={cx('title-function')}>
              <Button
                leftIcon={
                  <FontAwesomeIcon style={{ color: 'red' }} className={cx('title-function__btn-icon')} icon={faVideo} />
                }
          ...
          <div className={cx('story')}>
            <div className={cx('story-list-item')}>
              ...
              <div
                ...
                className={cx('story-item', 'story-item__friend')}
              >
            ...
            <div className={cx('content-title')}>
              <div className={cx('content-title__wrapping')}>
                ...
                <div className={cx('content-title__three-dot')}>
                  <Button className={cx('btn-three-not')} circle>
                    ...
                  </Button>
                </div>
                <div className={cx('content-title__x')}>
                  <Button className={cx('btn-x')} circle>
                    X
                  </Button>
                </div>
              </div>
